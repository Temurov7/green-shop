            ...
            <div className='container px-5'>
                <div className='bg-[#FBFBFB] p-5 flex items-center justify-between'>
                    <div className='w-[204px]'>
                        <Image className='mb-[17px]' src={"/gardenCare.svg"} alt='Plant' width={90} height={89} />
                    ...
                    <div className='w-[204px]'>
                        <Image className='mb-[17px]' src={"/plantRenovation.svg"} alt='Plant' width={90} height={89} />
                        <h3 className='mb-2 text-[#3D3D3D] font-bold text-[17px] leading-4'>Plant Renovation</h3>
                        <p className='text-[#727272] text-[14px] leading-[22px]'>We are an online plant shop offering a wide range of cheap and trendy plants.</p>
                    </div>
                    <div className='w-[204px]'>
                        <Image className='mb-[17px]' src={"/wateringGraden.svg"} alt='Plant' width={90} height={89} />
                    ...
                    <form>
                        ...
                        <label className='shadow relative mb-[17px]'>
                            <input className='w-[354px] py-[12px] pl-[11px] rounded-[6px] outline-none text-[#ACACAC] text-[14px] leading-4' type="email" placeholder='enter your email address...' autoComplete='off' name='email' />
                ...
                <div className='bg-[#ECF6EE] py-[23px] px-5 flex items-center justify-between'>
                    <a href="/">
                        <Image src={"/Logo.svg"} alt='Site logo' width={150} height={34} />
                    </a>
                    <div className='w-[200px] flex items-center space-x-2'>
                        <Image src={"/locationFooter.svg"} alt='Location' width={20} height={20} />
                        <p className='text-[#3D3D3D] text-[14px] leading-[22px]'>70 West Buckingham Ave. Farmingdale, NY 11735</p>
                    </div>
                    <div className=' flex items-center space-x-2'>
                        <Image src={"/messageFooter.svg"} alt='Location' width={20} height={20} />
                        <a href='mailto:contact@greenshop.com' className='text-[#3D3D3D] text-[14px] leading-[22px]'>contact@greenshop.com</a>
                    </div>
                    <div className=' flex items-center space-x-2'>
                        <Image src={"/callingFooter.svg"} alt='Location' width={20} height={20} />
                    ...
                    <ul>
                        ...
                        <div className='flex items-center gap-[10px] mb-[33px]'>
                            <a target='_blank' href="https://facebook.com">
                                <Image src={"/facebookiconFooter.svg"} alt='Facebook' width={30} height={30} />
                            </a>
                            <a target='_blank' href="https://instagram.com">
                                <Image src={"/instagramiconFooter.svg"} alt='Instagram' width={30} height={30} />
                            </a>
                            <a target='_blank' href="https://twitter.com">
                                <Image src={"/twittericonFooter.svg"} alt='Twitter' width={30} height={30} />
                            </a>
                            <a target='_blank' href="https://linkedin.com">
                                <Image src={"/linkediniconFooter.svg"} alt='Linkedin' width={30} height={30} />
                            </a>
                            <a target='_blank' href="https://union.com">
                                <Image src={"/unioniconFooter.svg"} alt='Union' width={30} height={30} />
                            </a>
                        </div>
                        <li className='text-[#3D3D3D] font-bold text-[18px] leading-4 mb-[13px]'>We accept</li>
                        <div className='flex items-center gap-[10px] mb-[33px]'>
                            <a target='_blank' href="https://visa.com">
                                <Image src={"/payiconFooter.svg"} alt='Visa' width={224} height={26} />
                            </a>
                        </div>
                    </ul>
                </div>
